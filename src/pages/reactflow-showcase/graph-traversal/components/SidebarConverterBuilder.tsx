...
const SidebarConverterBuilder = () => {
  ...
  return (
    <div className="border-border bg-card/40 flex max-h-40 w-full shrink-0 flex-col overflow-y-auto border-b text-left md:max-h-full md:w-60 md:border-r md:border-b-0">
      ...
      >
        <div
          className={`flex flex-col overflow-hidden transition-all duration-300 md:px-4 md:pb-4 ${openBuilderPanel ? "px-4 pb-4" : "px-4 pb-0"}`}
        >
...
export default SidebarConverterBuilder;
